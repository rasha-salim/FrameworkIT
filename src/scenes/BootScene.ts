...
// Player - Junior Engineer (blue hoodie, messy brown hair, laptop sticker on shirt)
const PLAYER_PIXELS: PixelData = [
  // Hair (messy brown)
  ...
  // Hoodie body (compact chibi body)
...
// Sarah - SRE Engineer (long red hair, green jacket, headset, green eyes)
const SARAH_PIXELS: PixelData = [
  // Long red hair
...
// Marcus - Senior Engineer (neat black hair, purple blazer, glasses, darker skin)
const MARCUS_PIXELS: PixelData = [
  // Neat black hair
...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    // Generate Chibi Tech character sprites
    this.createPixelArtSprite('player', CHAR_W, CHAR_H, SCALE, PLAYER_PIXELS);
    this.createPixelArtSprite('npc-sarah', CHAR_W, CHAR_H, SCALE, SARAH_PIXELS);
    this.createPixelArtSprite('npc-marcus', CHAR_W, CHAR_H, SCALE, MARCUS_PIXELS);

    // Environment sprites (keep simple)
